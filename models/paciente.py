...
class Paciente:
    ...
    @classmethod
    def save(cls,data):
        query = """INSERT INTO pacientes (nombre, apellido, ci_ruc, direccion,nro_telefono,fecha_nacimiento,sexo,patologia, created_at, updated_at, id_doctor) 
        VALUES (%(nombre)s,%(apellido)s,%(ci_ruc)s,%(direccion)s,%(nro_telefono)s,%(fecha_nacimiento)s,%(sexo)s,%(patologia)s,NOW(),NOW(), %(id_doctor)s);"""
